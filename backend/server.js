...
mongoose.connect(`mongodb+srv://${uname}:${pass}@cluster0.ye2fj.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`);
...
app.post("/add-product", upload.any(), (req, res) => {
  try {
    if (req.files && req.body && req.body.name && req.body.desc && req.body.launchDate && req.body.price &&
      req.body.discount && req.body.availability) {

      let new_product = new product();
      new_product.name = req.body.name;
      new_product.desc = req.body.desc;
      new_product.launchDate = req.body.launchDate;
      new_product.price = req.body.price;
      //new_product.image = req.files[0].filename;
      new_product.discount = req.body.discount;
      new_product.availability = req.body.availability;
...
app.post("/update-product", upload.any(), (req, res) => {
  try {
    if (req.files && req.body && req.body.name && req.body.desc && req.body.launchDate && req.body.price &&
      req.body.id && req.body.discount && req.body.availability) {
...
app.get("/get-product", (req, res) => {
  try {
    ...
    product.find(query, { date: 1, name: 1, id: 1, desc: 1, launchDate: 1, price: 1, discount: 1, availability: 1 })
